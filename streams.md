...
namespace Server
{
    class Server
    {
        ...
        static void Main(string[] args)
        {
            ...
            Byte[] data = System.Text.Encoding.ASCII.GetBytes(sklCode);

            // Get a client stream for reading and writing.
            //  Stream stream = client.GetStream();

            NetworkStream stream = _clients.GetStream();

            // Send the message to the connected TcpServer. 
            stream.Write(data, 0, data.Length);

            Console.WriteLine("Sent: {0}", sklCode);
...
namespace Client
{
    class Client
    {
        ...
        static void Main(string[] args)
        {
            //Console.WriteLine("Enter school code " + sklCode);
